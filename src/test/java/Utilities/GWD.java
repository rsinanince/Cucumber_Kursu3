...
public class GWD {
    ...
    public static WebDriver getDriver() {
        // extend report türkçe bilgisayar çalışmaması sebebiyle kondu
        ...
        if (threadBrowserName.get() == null) //paralel çalışmayan yani XML den parametre ile gelmeyen her çağıran için yaptık
