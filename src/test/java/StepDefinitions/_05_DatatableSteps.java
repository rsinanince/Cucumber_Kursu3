...
//            System.out.println("listElement = " + listElement.get(i));
    ...
    public void clickOnTheElementInTheDialogue(DataTable elements) {
...
//            System.out.println("listElement = " + listElement.get(i));
    ...
    public void userSendingTheKeysInDialogueContent(DataTable elements) {
    ...
    public void userDeleteItemFromDialogue (DataTable elements){
        List<String> listElement = elements.asList(String.class);
